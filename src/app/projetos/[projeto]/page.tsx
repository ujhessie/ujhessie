...
const ProjetoPage = ({ params }: { params: { projeto: string } }) => {
    ...
    return (
        <main>
            ...
            <MaxWidthContainer>
                <section className='content  bg-zinc-950 px-4 py-8 md:p-12 rounded-2xl shadow-sm text-center md:text-start flex flex-col md:grid md:grid-cols-7  gap-8 mb-8'>
